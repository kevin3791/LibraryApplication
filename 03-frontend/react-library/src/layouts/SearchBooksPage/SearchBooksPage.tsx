...
export const SearchBooksPage = () => {
    ...
    useEffect( () => {
        ...
        const fetchBooks = async () => { // wait for the Promise to come back
        ...
        // Call the fetchBooks() function and handle any errors
        fetchBooks().catch((error: any) => {
            setIsLoading(false);
            setHttpError(error.message);
        })

        // Each time this useEffect is triggered, scroll to the top
        window.scroll(0, 0);

    }, [currentPage, searchUrl]); // if variable in this array changes, the the useEffect function gets triggered
